...
function set_weight() {
    ...
    if (typeof(Storage) !== "undefined") {
        ...
        localStorage.setItem("weight1", JSON.stringify(weight_list[1]));
        localStorage.setItem("weight2", JSON.stringify(weight_list[2]));
        localStorage.setItem("weight3", JSON.stringify(weight_list[3]));
        localStorage.setItem("weight4", JSON.stringify(weight_list[4]));
        setList();
        location.reload();
    }
}
        ...
        data: [{
            ...
            dataPoints: [
                ...
                },
                {
                    ...
                    y: parseInt(localStorage.getItem("weight4"))
                },
                {
